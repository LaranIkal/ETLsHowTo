...
./hypertextperl.pl BatchProcess/LayoutBatchProcess.ppl Layout 001 ETLSample 2 9 3333 /tmp


# Output to database example
#./hypertextperl.pl BatchProcess/LayoutBatchProcess.ppl Layout 001 ETLSample 2 9 9
