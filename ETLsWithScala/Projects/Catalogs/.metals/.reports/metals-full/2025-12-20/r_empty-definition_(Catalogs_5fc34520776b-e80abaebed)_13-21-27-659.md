error id: file://<WORKSPACE>/Catalogs.sc:local2
...
object script {
  ...
  def main(parameters: Array[String]): Unit = { 
    ...
    Utils.WriteToTextFile(s"Log entry at $logFileD@@ateValue\n", logFileName)
    ...
    val targetDBConn = try {
      ...
      case e: Exception => 
        ...
        Utils.SendEmail(catalogsConfig("emailRecipients"), s"Error Opening Target DataBase Connection. ${e.getMessage}", "ETLMS - Error Notification")
    }
