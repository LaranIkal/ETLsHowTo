error id: file://<WORKSPACE>/Utils.sc:mailSmtpServer.
file://<WORKSPACE>/Utils.sc
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -jakarta/mail/mailSmtpServer.
	 -jakarta/mail/mailSmtpServer#
	 -jakarta/mail/mailSmtpServer().
	 -mailSmtpServer.
	 -mailSmtpServer#
	 -mailSmtpServer().
	 -scala/Predef.mailSmtpServer.
	 -scala/Predef.mailSmtpServer#
	 -scala/Predef.mailSmtpServer().
offset: 2720
...
* Author: Carlos Kassab - 2025-December-20
********************************************************************************/
def SendEmailAlert( mailRecipients: String, mailSubject: String, mailBody: String
                  ): Unit = {
...
*/
  ...
  try {
    ...
    props.put("mail.smtp.host", mailSmtpSer@@ver)
