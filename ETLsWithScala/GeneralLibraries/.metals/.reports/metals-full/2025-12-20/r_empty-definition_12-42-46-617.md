error id: file://<WORKSPACE>/Utils.sc:setFrom.
file://<WORKSPACE>/Utils.sc
empty definition using pc, found symbol in pc: setFrom.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -jakarta/mail/message/setFrom.
	 -jakarta/mail/message/setFrom#
	 -jakarta/mail/message/setFrom().
	 -message/setFrom.
	 -message/setFrom#
	 -message/setFrom().
	 -scala/Predef.message.setFrom.
	 -scala/Predef.message.setFrom#
	 -scala/Predef.message.setFrom().
offset: 2831
...
*/
  ...
  try {
    ...
    message.setFr@@om(new InternetAddress(fromAddress))
